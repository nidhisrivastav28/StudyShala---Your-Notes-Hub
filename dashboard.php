        ...
        <!--  <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>Explore firsthand experiences, testimonials, and success stories shared by our students. Dive into their journeys, insights, and triumphs, and discover the transformative power of education through their words.</p>
                </div>
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item bg-light rounded p-5">
                        <p class="fs-5">StudyShala has been a game-changer for me! The comprehensive notes provided for my BCA courses were invaluable in helping me grasp complex concepts easily. Thanks to StudyShala, I've aced my exams and feel more confident in my understanding of computer applications.
                    ...
                    <div class="testimonial-item bg-light rounded p-5">
                        <p class="fs-5">I can't thank StudyShala enough for the incredible support it provided throughout my MCA journey. The well-organized notes and resources were my go-to study companions, making challenging topics seem manageable. I highly recommend StudyShala to all MCA students seeking academic success!</p>
                        <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
                    ...
                    <div class="testimonial-item bg-light rounded p-5">
                        <p class="fs-5">I stumbled upon StudyShala while searching for study materials for my BCA courses, and it turned out to be a blessing in disguise! The well-structured notes and resources provided on the website have been instrumental in helping me achieve academic success. I'm incredibly grateful for the support StudyShala has offered me throughout my academic journey.</p>
                        <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
