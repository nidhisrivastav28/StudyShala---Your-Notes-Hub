        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="update_notes.php" method="post" enctype="multipart/form-data">
                        ...
                        <p>Notes:</p>
                        <p><input type="file" name="notes" accept=".pdf"></p>
                        <a href="<?php echo "uploads/notes/" . $row['notes']; ?>" target="_blank"
