...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['books']['name']) && $_FILES['books']['name'] != "") {
        ...
        $update_query = "UPDATE books SET course='$course', sem='$semester', sub='$subject', sub_name='$sub_name', books='$escaped_file_name', title='$title', auth='$author' WHERE fid='$id'";
    } else {
        $update_query = "UPDATE books SET course='$course', sem='$semester', sub='$subject', sub_name='$sub_name', title='$title', auth='$author' WHERE fid='$id'";
    }
