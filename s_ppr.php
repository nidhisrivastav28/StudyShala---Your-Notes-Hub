        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add Sample Papers</h1>

                    <form action="upload_sp.php" method="post" enctype="multipart/form-data">
                        <p>Choose Course:</p>
                        <p>
                        ...
                        <p>Sample Papers:</p>
                        <p><input type="file" name="sp" accept=".pdf"></p>
