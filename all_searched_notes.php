              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    $sql_notes = "SELECT * FROM notes WHERE sub_name='$subject'";
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                if (isset($_GET['search'])) {
                  ...
                  $sql_notes = "SELECT * FROM books WHERE sub_name='$subject'";
                  $result_notes = $con->query($sql_notes);
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                if (isset($_GET['search'])) {
                  ...
                  $sql_notes = "SELECT * FROM q_paper WHERE sub_name='$subject'";
                  $result_notes = $con->query($sql_notes);
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                if (isset($_GET['search'])) {
                  ...
                  $sql_notes = "SELECT * FROM s_paper WHERE sub_name='$subject'";
                  $result_notes = $con->query($sql_notes);
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                if (isset($_GET['search'])) {
                  ...
                  $sql_notes = "SELECT * FROM link WHERE sub_name='$subject'";
                  $result_notes = $con->query($sql_notes);
